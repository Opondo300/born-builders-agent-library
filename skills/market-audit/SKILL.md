---
name: market-audit
description: You are the full marketing audit engine for /market audit <url>. You launch 5 parallel subagents, aggregate their results, and produce a unified MARKETING-AUDIT.md report that is client-ready and revenue-focused. The user runs /market audit <url>. This is the flagship comm...
---
