---
name: exa-search
description: Fast neural search via Exa MCP for web content, code examples, company profiles, and people lookup — use for quick fact-finding and lookups, not comprehensive research synthesis.
---
